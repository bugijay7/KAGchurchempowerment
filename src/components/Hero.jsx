...
function Hero() {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: "url('/src/assets/hero-bg.jpg')" }} // <-- your image path
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button
            ...
            className="bg-white text-blue-900 px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-50 transition transform hover:scale-105 shadow-xl flex items-center gap-2"
          >
            Join Us <ChevronRight className="w-5 h-5" />
          </button>
          <button
            onClick={() => scrollToSection("sermons")}
            className="bg-blue-600/80 backdrop-blur-sm text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-700 transition transform hover:scale-105 border-2 border-white/30 flex items-center gap-2"
          >
        ...
        {/* Service Info */}
        <div className="inline-flex flex-col sm:flex-row gap-6 bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
